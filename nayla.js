...
reply("[❗] SEDANG DIPROSES")
nayla.sendMessage(from, {image:{url:`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=Imanmpa&text1=${q1}&text2=${q2}`}, caption:"👍", mentions:[sender]},{quoted:nay1})
break 
...
reply("[❗] SEDANG DIPROSES")
nayla.sendMessage(from, {image:{url:`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=Imanmpa&text=${q}`}, caption:"👍", mentions:[sender]},{quoted:nay1})
break
